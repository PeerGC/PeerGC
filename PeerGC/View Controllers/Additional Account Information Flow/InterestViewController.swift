...
class InterestViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if AccountTypeViewController.data.accountType == "Student" {
            subLabel.text = "EDyou uses this information to match you with tutors who share similar interests to you."
        }
        
        else if AccountTypeViewController.data.accountType == "Tutor" {
            subLabel.text = "EDyou uses this information to match you with students who share similar interests to you."
        }
        
        AccountTypeViewController.data.interest = "STEM"
